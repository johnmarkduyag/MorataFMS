        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-sky-50 dark:to-blue-100 rounded-[2rem] p-6 border border-blue-100 dark:border-blue-200 flex-1 shadow-sm">
                        ...
                        <p className="text-sm text-gray-900 font-bold">Manila, Philippines</p>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-sky-50 dark:to-blue-100 rounded-[2rem] p-6 border border-blue-100 dark:border-blue-200 flex-1 shadow-sm">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <span className="text-sm font-semibold text-gray-700">Today's Date</span>
                        </div>
            ...
            <div className="bg-white rounded-[2rem] p-6 border border-gray-100 shadow-sm transition-colors">
                <div className="flex justify-between items-center mb-4">
                    <h3 className="text-lg font-bold text-gray-900">Import List</h3>
                ...
                {/* Table Header */}
                <div className="grid gap-4 pb-3 border-b border-gray-200 mb-3 px-2 font-bold"
